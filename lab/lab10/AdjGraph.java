// H343 / Spring 2017 Lab 10 Andrew Mathies awmathie
...
public class AdjGraph implements Graph {
    ...
    public void init() {
        ...
        digraph = false;
	components = 0;
	componentSizes = new ArrayList<Integer>();
    }
    // set vertices
	...
	if (mark != 0)
        ...
        System.out.println("Total Components: " + this.components);
	for (int i = 0; i < componentSizes.size(); i++)
	    System.out.println("component " + i + " contains " + componentSizes.get(i) + " node(s)");
    }
